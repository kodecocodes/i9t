...
/*!
 * jQuery scrollIt.js
 * Simple page smooth scrolling script
 * Dependancies: jQuery Easing plugin
 * Created by: Steve O. @ vdotgood.com
 */
$.fn.scrollIt=function(c,b,e,a,d){if(a==null){a="y"}if(d==null){d="easeInOutCubic"}if(b===0){window.scrollTo(c.left,c.top);if(e){e()}}else{switch(a){case"x":this.stop().animate({scrollLeft:c.left},b,d,function(){if(e){e()}});break;case"y":this.stop().animate({scrollTop:c.top},b,d,function(){if(e){e()}});break;case"both":this.stop().animate({scrollLeft:c.left},b,d,function(){$(this).stop().animate({scrollTop:c.top},b,d,function(){if(e){e()}})});break}}};
